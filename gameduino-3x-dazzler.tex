...
\subsection{Accessing the boot menu}

If you have a Wii-classic controller,
...
\pngw{img/gameduino-3x-dazzler/wii-bootmenu.png}{1.0}

The display will switch to the boot menu.

\pngw{img/gameduino-3x-dazzler/bootmenu1.png}{1.0}

The three icons on the right display the connection status of the
...
\item The gamepad boot menu. Select slot 1.

\item The Dazzler serial console. Use command \mach{ 1 run}

\item The Dazzler SPI interface.
