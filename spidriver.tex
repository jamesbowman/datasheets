...
\newpage
\begin{center}
\includegraphics[width=1.00\textwidth]{img/spidriver/spi_driver_topdown_wired_powered_white_bg}
...
\begin{tabular}{ccl}
\hline
\cellcolor{orange} \textcolor{black}{\textbf{SCK}} & orange & SPI clock\\
\cellcolor{yellow} \textcolor{black}{\textbf{MISO}} & yellow & SPI Master In Slave Out\\
\cellcolor{green} \textcolor{black}{\textbf{MOSI}} & green  & SPI Master Out Slave In \\
\cellcolor{blue} \textcolor{white}{\textbf{CS}}   & blue   & SPI Chip Select\\
\cellcolor{purple} \textcolor{white}{\textbf{A}}    & purple & Auxiliary control A\\
\cellcolor{gray} \textcolor{white}{\textbf{B}}    & gray   & Auxiliary control B\\
\hline
\end{tabular}
\end{center}
\gap
